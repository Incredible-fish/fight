...
2.从3.1.0开始，若是代码是被旧版本代码获取的，将不会在监测更新，最新版本不受影响(可在设置中取消暂停监测)
3.优化了更新时的重启
4.解决了设置的局部修改全局变量的报错
...
#fight库
fight_list = ["fight3.1.0","fight3.0.1","fight3.0.0","fight2.1.0","fight2.0.0","fight0.0.0"]
