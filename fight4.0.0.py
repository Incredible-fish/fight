...
#fight库
fight_list = ["fight4.0.0","fight3.2.2","fight3.2.1","fight3.2.0","fight3.1.0","fight3.0.0","fight2.1.0","fight2.0.0","fight0.0.0"]
    ...
    def get_fight_other(self):
        ...
        try:
            ...
            for item in range(0, len(find_code)):
                remote_code = find_code[item][54:len(find_code) - 18]
...
def automatic_update():
    try:
        ...
        fight_all_req_version = []
        for item in range(0,len(find_code)):
            fight_all_req = find_code[item][54:len(find_code)-18]
