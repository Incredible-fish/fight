...
#fight库
fight_list = ["fight4.1.1","fight4.1.0","fight4.0.1","fight4.0.0","fight3.2.2","fight3.2.1","fight3.2.0","fight3.1.0","fight3.0.0","fight2.1.0","fight2.0.0","fight0.0.0"]
...
class menu():
    #菜单功能 3.设置
    def set(self):
        global Can_fight,Can_Break_Defense,Can_stockpile,key_Break_Defense,key_defense,key_fight,key_stockpile,exit_key,Can_clean
