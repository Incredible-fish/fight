...
#fight库
fight_list = ["fight5.0.0","fight4.1.1","fight4.1.0","fight4.0.1","fight4.0.0","fight3.2.2","fight3.2.1","fight3.2.0","fight3.1.0","fight3.0.0","fight2.1.0","fight2.0.0","fight0.0.0"]
...
class menu():
    ...
    def login(self,auto_user = None):
        global login_state, login_user_name, Automatic_login, user_data, save_mode
